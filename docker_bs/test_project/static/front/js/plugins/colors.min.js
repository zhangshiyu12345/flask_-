 ...
 */
! function(a) {
	a.Editable.COLORS = ["#000000", "#444444", "#666666", "#999999", "#CCCCCC", "#EEEEEE", "#F3F3F3", "#FFFFFF",
		...
		"#45818E", "#3D85C6", "#674EA7", "#A64D79", "#990000", "#B45F06", "#BF9000", "#38771D", "#134F5C",
		...
		this.$editor.find(".fr-color-picker button.fr-color-bttn").removeClass("active"), this.refreshColor(a,
			"background-color", "backColor"), this.refreshColor(a, "color", "foreColor")
		...
		for (; a(b).get(0) != this.$element.get(0);) {
			if ("transparent" !== a(b).css(c) && "rgba(0, 0, 0, 0)" !== a(b).css(c)) {
				this.$editor.find('.fr-color-picker button.fr-color-bttn[data-cmd="' + d + '"][data-val="' + a
					.Editable.RGBToHex(a(b).css(c)) + '"]').addClass("active");
				break
			}
			b = a(b).parent()
		}
		...
		color: {
			...
			callbackWithoutSelection: function(b, c, d) {
				"backColor" === d && (d = "background-color"), "foreColor" === d && (d = "color"), this
					._startInFontExec(d, b, c), "#123456" === c && "" === this.text() && (this.cleanify(!0,
						!1), this.$element.find("span").each(function(b, c) {
						var d = a(c),
							e = d.css("background-color");
						("#123456" === e || "#123456" === a.Editable.RGBToHex(e)) && d.css(
							"background-color", ""), e = d.css("color"), ("#123456" === e ||
							"#123456" === a.Editable.RGBToHex(e)) && d.css("color", "")
					}))
			},
			undo: !0
		}
		...
		for (var b = '<div class="fr-dropdown-menu">', c = 0; c < a.seed.length; c++) {
			for (var d = a.seed[c], e = '<div><p><span data-text="true">' + d.title +
					'</span> <a data-val="#123456" data-cmd="color" data-param="' + d.cmd +
					'" class="fr-bttn" title="Clear"><i class="fa fa-eraser"></i></a></p>', f = 0; f < d.value
				.length; f++) {
				var g = d.value[f];
				e += '<button type="button" class="fr-color-bttn" data-val="' + g +
					'" data-cmd="color" data-param="' + d.cmd + '" style="background-color: ' + g +
					';">&nbsp;</button>', f % 8 == 7 && f > 0 && (e += "<hr/>", (7 == f || 15 == f) && (e +=
